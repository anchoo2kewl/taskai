...
// was not loaded in eager-loading, or loaded but was not found.
func (e ProjectMemberEdges) GranterOrErr() (*User, error) {
	if e.Granter != nil {
...
func (*ProjectMember) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case projectmember.FieldID, projectmember.FieldProjectID, projectmember.FieldUserID, projectmember.FieldGrantedBy:
...
// QueryGranter queries the "granter" edge of the ProjectMember entity.
func (_m *ProjectMember) QueryGranter() *UserQuery {
	return NewProjectMemberClient(_m.config).QueryGranter(_m)
}
