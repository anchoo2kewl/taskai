...
func (_q *InviteQuery) QueryInviter() *UserQuery {
...
func (_q *InviteQuery) QueryInvitee() *UserQuery {
	query := (&UserClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
...
func (_q *InviteQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *InviteQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *InviteQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *InviteQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *InviteQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (_q *InviteQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *InviteQuery) WithInviter(opts ...func(*UserQuery)) *InviteQuery {
	query := (&UserClient{config: _q.config}).Query()
...
func (_q *InviteQuery) WithInvitee(opts ...func(*UserQuery)) *InviteQuery {
	query := (&UserClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *InviteQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Invite, error) {
	...
	if query := _q.withInviter; query != nil {
		if err := _q.loadInviter(ctx, query, nodes, nil,
			func(n *Invite, e *User) { n.Edges.Inviter = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withInvitee; query != nil {
		if err := _q.loadInvitee(ctx, query, nodes, nil,
			func(n *Invite, e *User) { n.Edges.Invitee = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *InviteQuery) loadInviter(ctx context.Context, query *UserQuery, nodes []*Invite, init func(*Invite), assign func(*Invite, *User)) error {
...
func (_q *InviteQuery) loadInvitee(ctx context.Context, query *UserQuery, nodes []*Invite, init func(*Invite), assign func(*Invite, *User)) error {
	ids := make([]int64, 0, len(nodes))
	nodeids := make(map[int64][]*Invite)
	for i := range nodes {
...
func (_q *InviteQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withInviter != nil {
			_spec.Node.AddColumnOnce(invite.FieldInviterID)
		}
		if _q.withInvitee != nil {
			_spec.Node.AddColumnOnce(invite.FieldInviteeID)
		}
	}
