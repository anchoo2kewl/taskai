...
func (_c *TagCreate) SetTeamID(v int64) *TagCreate {
	_c.mutation.SetTeamID(v)
	return _c
}

// SetNillableTeamID sets the "team_id" field if the given value is not nil.
func (_c *TagCreate) SetNillableTeamID(v *int64) *TagCreate {
	if v != nil {
		_c.SetTeamID(*v)
	}
	return _c
...
func (_c *TagCreate) SetTeam(v *Team) *TagCreate {
	return _c.SetTeamID(v.ID)
}

// AddTaskTagIDs adds the "task_tags" edge to the TaskTag entity by IDs.
func (_c *TagCreate) AddTaskTagIDs(ids ...int) *TagCreate {
