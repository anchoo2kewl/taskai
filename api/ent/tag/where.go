...
func TeamID(v int64) predicate.Tag {
	return predicate.Tag(sql.FieldEQ(FieldTeamID, v))
}
...
func TeamIDEQ(v int64) predicate.Tag {
	return predicate.Tag(sql.FieldEQ(FieldTeamID, v))
}

// TeamIDNEQ applies the NEQ predicate on the "team_id" field.
func TeamIDNEQ(v int64) predicate.Tag {
	return predicate.Tag(sql.FieldNEQ(FieldTeamID, v))
}

// TeamIDIn applies the In predicate on the "team_id" field.
func TeamIDIn(vs ...int64) predicate.Tag {
	return predicate.Tag(sql.FieldIn(FieldTeamID, vs...))
}

// TeamIDNotIn applies the NotIn predicate on the "team_id" field.
func TeamIDNotIn(vs ...int64) predicate.Tag {
	return predicate.Tag(sql.FieldNotIn(FieldTeamID, vs...))
}

// TeamIDIsNil applies the IsNil predicate on the "team_id" field.
func TeamIDIsNil() predicate.Tag {
	return predicate.Tag(sql.FieldIsNull(FieldTeamID))
}

// TeamIDNotNil applies the NotNil predicate on the "team_id" field.
func TeamIDNotNil() predicate.Tag {
	return predicate.Tag(sql.FieldNotNull(FieldTeamID))
}
...
func HasTeamWith(preds ...predicate.Team) predicate.Tag {
	return predicate.Tag(func(s *sql.Selector) {
		step := newTeamStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
