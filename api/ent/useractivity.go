...
func (*UserActivity) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case useractivity.FieldID, useractivity.FieldUserID:
			values[i] = new(sql.NullInt64)
		case useractivity.FieldActivityType, useractivity.FieldIPAddress, useractivity.FieldUserAgent:
...
func (_m *UserActivity) assignValues(columns []string, values []any) error {
...
func (_m *UserActivity) Value(name string) (ent.Value, error) {
	return _m.selectValues.Get(name)
}

// QueryUser queries the "user" edge of the UserActivity entity.
func (_m *UserActivity) QueryUser() *UserQuery {
	return NewUserActivityClient(_m.config).QueryUser(_m)
}
...
func (_m *UserActivity) Update() *UserActivityUpdateOne {
	return NewUserActivityClient(_m.config).UpdateOne(_m)
}

// Unwrap unwraps the UserActivity entity that was returned from a transaction after it was closed,
// so that all future queries will be executed through the driver which created the transaction.
func (_m *UserActivity) Unwrap() *UserActivity {
...
func (_m *UserActivity) String() string {
