    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-dark-bg-base to-dark-bg-primary px-4 relative">
      ...
      <Card className="max-w-md w-full">
        ...
        <CardBody>
          ...
          {/* OAuth sign-up — only shown when a valid invite is present */}
          {inviteValid === true && inviteCode && (
            <div className="mt-6">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-xs">
                  <span className="px-2 bg-dark-bg-secondary text-dark-text-quaternary">or sign up with</span>
                </div>
              </div>
