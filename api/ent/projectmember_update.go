...
func (_u *ProjectMemberUpdate) SetGrantedBy(v int64) *ProjectMemberUpdate {
	_u.mutation.SetGrantedBy(v)
	return _u
}

// SetNillableGrantedBy sets the "granted_by" field if the given value is not nil.
func (_u *ProjectMemberUpdate) SetNillableGrantedBy(v *int64) *ProjectMemberUpdate {
	if v != nil {
		_u.SetGrantedBy(*v)
	}
	return _u
...
func (_u *ProjectMemberUpdate) SetGranterID(id int64) *ProjectMemberUpdate {
	_u.mutation.SetGranterID(id)
	return _u
}

// SetGranter sets the "granter" edge to the User entity.
func (_u *ProjectMemberUpdate) SetGranter(v *User) *ProjectMemberUpdate {
	return _u.SetGranterID(v.ID)
}
...
func (_u *ProjectMemberUpdate) ClearGranter() *ProjectMemberUpdate {
	_u.mutation.ClearGranter()
	return _u
}
...
func (_u *ProjectMemberUpdate) check() error {
	...
	if _u.mutation.GranterCleared() && len(_u.mutation.GranterIDs()) > 0 {
		return errors.New(`ent: clearing a required unique edge "ProjectMember.granter"`)
	}
	return nil
}
...
func (_u *ProjectMemberUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if nodes := _u.mutation.GranterIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   projectmember.GranterTable,
...
// SetGrantedBy sets the "granted_by" field.
func (_u *ProjectMemberUpdateOne) SetGrantedBy(v int64) *ProjectMemberUpdateOne {
	_u.mutation.SetGrantedBy(v)
	return _u
}

// SetNillableGrantedBy sets the "granted_by" field if the given value is not nil.
func (_u *ProjectMemberUpdateOne) SetNillableGrantedBy(v *int64) *ProjectMemberUpdateOne {
	if v != nil {
		_u.SetGrantedBy(*v)
	}
	return _u
...
// SetGranterID sets the "granter" edge to the User entity by ID.
func (_u *ProjectMemberUpdateOne) SetGranterID(id int64) *ProjectMemberUpdateOne {
	_u.mutation.SetGranterID(id)
	return _u
}

// SetGranter sets the "granter" edge to the User entity.
func (_u *ProjectMemberUpdateOne) SetGranter(v *User) *ProjectMemberUpdateOne {
	return _u.SetGranterID(v.ID)
}
...
// ClearGranter clears the "granter" edge to the User entity.
func (_u *ProjectMemberUpdateOne) ClearGranter() *ProjectMemberUpdateOne {
	_u.mutation.ClearGranter()
	return _u
}
